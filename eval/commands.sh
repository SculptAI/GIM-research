...
python -m eval.mcqa.gpqa_diamond --model_name Qwen/Qwen3-235B-A22B-Instruct-2507 --base_url https://api.siliconflow.cn/v1 --is_gim_prompt --reason_budget 2 --num_proc 10 --first_n 198
