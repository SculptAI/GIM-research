...
ds = load_dataset("Ki-Seki/UHGEvalDataset", name="full", split="validation", num_proc=os.cpu_count())
ds = ds.map(_mask_possion_4, num_proc=os.cpu_count()).select_columns([QUERY_COLUMN, RESPONSE_COLUMN])
